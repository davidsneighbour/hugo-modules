...
module.exports = JSON.parse('{"name":"hugo-blockify","description":"@davidsneighbour\'s reusable gohugo components.","version":"0.0.90","license":"MIT","private":true,"repository":"davidsneighbour/hugo-blockify","author":"Patrick Kollitsch <patrick@davids-neighbour.com> (https://davids-neighbour.com)","bugs":"https://github.com/davidsneighbour/hugo-blockify/issues","homepage":"https://github.com/davidsneighbour/hugo-blockify#readme","dependencies":{"@davidsneighbour/babel-config":"^5.2.2","@davidsneighbour/bootstrap-config":"5.1.39","@davidsneighbour/browserslist-config":"^5.2.4","@davidsneighbour/commitlint-config":"^5.2.8","@davidsneighbour/cssnano-config":"^5.2.10","@davidsneighbour/cypress-config":"^5.2.5","@davidsneighbour/eslint-config":"^5.2.5","@davidsneighbour/htmlvalidate-config":"^5.2.4","@davidsneighbour/markdownlint-config":"^5.2.2","@davidsneighbour/postcss-config":"^5.2.5","@davidsneighbour/prettier-config":"5.1.31","@davidsneighbour/remark-config":"5.1.38","@davidsneighbour/standard-version-config":"5.0.16","@davidsneighbour/stylelint-config":"^5.2.5","@davidsneighbour/textlint-config":"5.0.16","@davidsneighbour/tools":"^5.2.9","@davidsneighbour/webpack-config":"^5.2.7","@slightlyoff/lite-vimeo":"0.1.2","all-contributors-cli":"6.26.0","workbox-cacheable-response":"7.0.0","workbox-core":"7.0.0","workbox-expiration":"7.0.0","workbox-precaching":"7.0.0","workbox-routing":"7.0.0","workbox-strategies":"7.0.0","workbox-webpack-plugin":"7.0.0"},"scripts":{"build":"run-p build:*","build:webpack":"cross-env NODE_ENV=production webpack --config webpack.js","clean":"run-p clean:**","clean:hugo":"rimraf dev/public dev/resources dev/.hugo_build.lock hugo.log","clean:node":"rimraf node_modules package-lock.json","release":"standard-version --release-as patch -a -t \\"v\\" --releaseCommitMessageFormat \\"chore(release): v{{currentTag}}\\" && ./bin/release/postrelease","release:minor":"standard-version --release-as minor -a -t \\"v\\" --releaseCommitMessageFormat \\"chore(release): v{{currentTag}}\\" && ./bin/release/postrelease","serve:webpack":"webpack --watch --config webpack.js"}}');
