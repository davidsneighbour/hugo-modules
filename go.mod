...
require (
	...
	github.com/davidsneighbour/hugo-head v1.1.20 // indirect
	github.com/davidsneighbour/hugo-robots v1.2.15 // indirect
	github.com/davidsneighbour/hugo-sitemap v1.1.10 // indirect
